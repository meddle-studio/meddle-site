!(function () {
  ...
  !(function (t) {
      let i = {
              ...
              searchResultTemplate: '<div markdown="1" class="faq mb-3"><div markdown="1" class="faq-header" id="heading{i}"><h3 markdown="1" class="-serif"><button markdown="1" class="btn btn-link btn-block px-4 py-3 text-left" type="button" data-toggle="collapse" data-target="#collapse{i}" aria-expanded="true" aria-controls="collapse{i}">{question}</button></h3></div><div markdown="1" id="collapse{i}" class="collapse show" aria-labelledby="heading{i}"><div markdown="1" class="faq-body py-3 px-4" data-markdown="1" markdown="1">{answer}</div></div></div>',
      ...
      function s(t) {
          ...
          i.resultsContainer.innerHTML += html;
          $('#faqs .accordion').hide();
      }
      function l(t) {
          var e;
